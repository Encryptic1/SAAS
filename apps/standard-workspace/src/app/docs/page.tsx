...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Workspace"
      tagline="Portfolio control panel: status grid, sessions, tunnels, depsync."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Workspace is part of the Market Standard suite. Portfolio control panel: status grid, sessions, tunnels, depsync. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Open the dashboard to see the 14-app status grid.</li><li>Start a dev session and tail logs over SSE.</li><li>Create a webhook tunnel for local intake routes.</li><li>Run depsync to check package parity across apps.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Workspace — product overview", src: "" },
