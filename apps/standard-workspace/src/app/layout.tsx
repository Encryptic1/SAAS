...
const description =
  "One pane for the whole Market Standard suite: live status grid of 14 apps + FloodG8 + SyncDevTime + Supabase + Stripe. Start dev sessions, tail logs over SSE, manage webhook tunnels, and track dependency parity.";
