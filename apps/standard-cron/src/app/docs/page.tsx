...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Cron"
      tagline="Monitor cron jobs with heartbeats."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Cron is part of the Market Standard suite. Monitor cron jobs with heartbeats. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Register a job and grab its heartbeat token.</li><li>POST to /api/heartbeat/:token after each run.</li><li>Inspect runs and drift.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Cron — product overview", src: "" },
