...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      tagline="Collect and publish customer testimonials."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Proof is part of the Market Standard suite. Collect and publish customer testimonials. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a collection.</li><li>Add testimonials and pin the best.</li><li>Publish your public wall.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Proof — product overview", src: "" },
