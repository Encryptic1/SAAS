...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Regex"
      tagline="Save, test, and share regex patterns."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Regex is part of the Market Standard suite. Save, test, and share regex patterns. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a pattern with tests.</li><li>Browse public patterns.</li><li>Fork a pattern to make it your own.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Regex — product overview", src: "" },
