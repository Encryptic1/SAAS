...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      tagline="Run polls and stand-ups inside Slack."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Polls is part of the Market Standard suite. Run polls and stand-ups inside Slack. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Install the Slack bot with /polls.</li><li>Create a poll from the dashboard or Slack.</li><li>Review analytics to track participation.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Polls — product overview", src: "" },
