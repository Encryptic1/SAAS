...
const PRODUCT = "standard-release" as const;
...
export default async function BillingPage({ searchParams }: BillingPageProps) {
  ...
  return (
    <>
      ...
      <p className="mt-2 ms-app-muted">Manage your Standard Release subscription.</p>
      ...
      <Card className="mt-8">
        ...
        <CardContent className="space-y-4">
          <ul className="text-sm ms-app-muted">
            <li>Repos: {String(plan.limits.repos)}</li>
            <li>Generations/month: {String(plan.limits.releasesPerMonth)}</li>
        ...
        {paidPlans.map((tier) => {
          ...
          return (
            <Card key={tier.tier}>
              ...
              <CardContent className="space-y-4">
                <ul className="text-sm ms-app-muted">
                  <li>{String(tier.limits.repos)} repos</li>
                  <li>{String(tier.limits.releasesPerMonth)} generations/mo</li>
