...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Snippets"
      tagline="Versioned, shareable code snippets."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Snippets is part of the Market Standard suite. Versioned, shareable code snippets. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a snippet.</li><li>Every save creates a version.</li><li>Generate a shareable link.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Snippets — product overview", src: "" },
