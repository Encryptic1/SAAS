...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Status"
      tagline="Pipelines, deployments, and incidents."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Status is part of the Market Standard suite. Pipelines, deployments, and incidents. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a pipeline.</li><li>Log deployments.</li><li>Open an incident when things break.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Status — product overview", src: "" },
