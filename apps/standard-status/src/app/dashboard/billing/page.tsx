    ...
    <StatusDashboardShell>
      <div className="space-y-6 max-w-2xl">
        <div>
          ...
          <p className="text-sm ms-app-muted">Manage your Standard Status subscription.</p>
        </div>
        <div className="ms-card p-4 space-y-2">
          <p className="text-sm">
            Free plan: up to <strong>3 pipelines</strong>. Upgrade to track up to 25 pipelines with auto-sync from GitHub + Vercel.
          </p>
