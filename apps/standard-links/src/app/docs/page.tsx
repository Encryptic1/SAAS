...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Links"
      tagline="Short links with click analytics."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Links is part of the Market Standard suite. Short links with click analytics. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a short link.</li><li>Share it.</li><li>Review analytics for clicks and referrers.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Links — product overview", src: "" },
