...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Vault"
      tagline="Encrypted secrets for projects."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Vault is part of the Market Standard suite. Encrypted secrets for projects. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create a project.</li><li>Add secrets with envelope encryption.</li><li>Mint a read-only token for CI.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Vault — product overview", src: "" },
