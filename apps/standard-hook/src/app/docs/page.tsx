...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Hook"
      tagline="Capture, inspect, and replay webhooks."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Hook is part of the Market Standard suite. Capture, inspect, and replay webhooks. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Create an inbox to get a capture URL.</li><li>POST events to the inbox slug.</li><li>Replay events downstream.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Hook — product overview", src: "" },
