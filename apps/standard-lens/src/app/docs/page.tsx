...
export default function DocsPageRoute() {
  ...
  return (
    <DocsPage
      ...
      productName="Standard Lens"
      tagline="Optimize slow database queries."
      sections={[
        {
          id: "overview",
          title: "Overview",
          body: <p>Standard Lens is part of the Market Standard suite. Optimize slow database queries. This page documents the product and its HTTP API.</p>,
        },
        {
          id: "getting-started",
          ...
          body: (
            <ul>
              <li>Save your most-used queries.</li><li>Paste an EXPLAIN plan for findings.</li><li>Review the slow queries tab.</li>
            </ul>
          ),
        },
        {
      ...
      loomVideos={[
        { id: "overview", title: "Standard Lens — product overview", src: "" },
